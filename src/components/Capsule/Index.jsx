    ...
    >
        <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start " >
            <h1 className="w-2/3 font-[Sansita] text-[2.8vh] leading-[4vh] font-medium">
                Stay up-to-date what
                I created recently
                see my innovation and
                other works of mine.
            </h1>
            <div className="heading">
                <h1 className="font-[SansitaReg] text-[5vh] leading-[6.5vh] sm:text-[8vh] py-5 sm:leading-[9vh]">Explore <br/>other Works</h1>
        ...
        <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
            ...
            <div   
                ...
                <div className="text text-center text-[6vw] sm:text-[3.2vh] font-semibold mt-10 leading-[4.8vh]">
                    <h3>Creative Business<br/>
                         Landing Page: where business<br/>meets design, and first<br/>impressions
                       are always<br/>unforgettable
                    </h3> 
                </div>
            ...
            >
                ...
                <div className="text text-center text-[3.2vh] flex flex-col gap-6 mb-6 font-semibold leading-[4.8vh]">
                    <h3>Sleek Startup Landing Page,<br/>
                         Modern Business Portfolio,<br/>Minimalist Corporate <br/>Website and more.
                    </h3>
                    <h4 className="font-[Sansita] text-[1.9vh] font-medium leading-[2.8vh] text-zinc-500">Where vision meets reality—launch<br/>your ideas with a landing page<br/>that captivates and converts<br/>from the very first glance.<br/>
